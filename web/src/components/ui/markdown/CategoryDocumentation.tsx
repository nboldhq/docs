      ...
      <div className="w-full max-w-[20rem] sm:max-w-[28rem] md:max-w-6xl px-4 sm:px-6 lg:px-8 mx-auto"> 
              <ReactMarkdown
                ...
                components={{
                  ...
                  ul: ({ ...props }) => (
                    <ul
                      className="list-disc list-inside ml-5 mb-6 space-y-3 text-gray-700 dark:text-gray-400"
                      {...props}
                    />
                  ),
                  ol: ({ ...props }) => (
                    <ol
                      className="list-decimal list-inside ml-5 mb-6 space-y-3 text-gray-700 dark:text-gray-400"
                      {...props}
                    />
                  ),
                  li: ({ ...props }) => (
                  ...
                  a: ({ ...props }) => (
                    <a
                      className="text-[#ff003d] dark:text-[#ff527d] hover:underline font-medium transition-colors duration-200"
                      {...props}
                    />
                  ),
                  img: ({ ...props }) => (
                    <figure className="flex flex-col my-8 rounded-xl overflow-hidden shadow-lg border border-gray-200 dark:border-gray-700 group">
                      <img
                        className="w-full h-auto max-w-full object-cover transition-transform duration-300 hover:scale-105"
                        {...props}
                      />
                      {props.alt && (
                  ...
                  blockquote: ({ ...props }) => (
                    <blockquote
                      className="border-l-4 border-[#606060ab] bg-gray-100 dark:bg-[#18181B] p-6 my-8 rounded-lg text-gray-700 dark:text-gray-300 italic"
                      {...props}
                    />
                  ),
