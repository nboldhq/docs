...
### Setup
Access to targeted release is controlled by an [RBAC](/trust-center/authentication-and-access-control) policy. To grant a user access to targeted release features:
