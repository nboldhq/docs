...
* **permissions:** adjusted default permissions scopes ([3ffc386](https://github.com/nboldhq/app-platform/commit/3ffc386a9ef90e729d6db58c8321e2dd062cee7a))
  ...
  - Client-side events
    ...
    - "Page View" events properties:
      - Standard properties (Automatically collected):
        ```js
        Page view URL: 'https://avi.nbold.dev/catalog...'
...
- fixed: Cloned team selection filter
  ...
  - Known issue "Missing teams in list all teams when creating a new template"
