...
To learn more about why we rely on a Service Account and what are the best practices to secure it, please visit our_ [_Trust Center_](/trust-center/trust-center).
...
Login to [https://teams.microsoft.com](https://teams.microsoft.com "https://teams.microsoft.com") with the account you created. Reach the nBold app by searching "nBold" through the three dots on the left bar.
