...
WEB_SESSION_SECRET=b723a4da-8e88-42a1-b7fc-de4a435513a6
...
# (string) HTTP user agent passed as a header with each request. Defaults to `nBold-Webhook/v5.1.0`.
WEBHOOKS_USER_AGENT=nBold-Webhook/v5.1.0
