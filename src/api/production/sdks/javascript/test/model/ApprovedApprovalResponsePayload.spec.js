...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new nBoldApi.ApprovedApprovalResponsePayload();
  });
  ...
  describe('ApprovedApprovalResponsePayload', function() {
    it('should create an instance of ApprovedApprovalResponsePayload', function() {
      ...
      //var instance = new nBoldApi.ApprovedApprovalResponsePayload();
      //expect(instance).to.be.a(nBoldApi.ApprovedApprovalResponsePayload);
    });
