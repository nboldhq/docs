...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new nBoldApi.ApiErrorErrorInnerError();
  });
  ...
  describe('ApiErrorErrorInnerError', function() {
    it('should create an instance of ApiErrorErrorInnerError', function() {
      ...
      //var instance = new nBoldApi.ApiErrorErrorInnerError();
      //expect(instance).to.be.a(nBoldApi.ApiErrorErrorInnerError);
    });
