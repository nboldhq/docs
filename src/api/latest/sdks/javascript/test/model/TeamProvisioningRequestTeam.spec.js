...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new nBoldApi.TeamProvisioningRequestTeam();
  });
  ...
  describe('TeamProvisioningRequestTeam', function() {
    it('should create an instance of TeamProvisioningRequestTeam', function() {
      ...
      //var instance = new nBoldApi.TeamProvisioningRequestTeam();
      //expect(instance).to.be.a(nBoldApi.TeamProvisioningRequestTeam);
    });
