...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new nBoldApi.TeamChannelTabConfiguration();
  });
  ...
  describe('TeamChannelTabConfiguration', function() {
    it('should create an instance of TeamChannelTabConfiguration', function() {
      ...
      //var instance = new nBoldApi.TeamChannelTabConfiguration();
      //expect(instance).to.be.a(nBoldApi.TeamChannelTabConfiguration);
    });
