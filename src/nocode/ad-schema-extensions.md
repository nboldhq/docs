...
**ABSTRACT**  
This article describes how you can leverage the SalesTim platform to create [naming conventions](/nocode/naming-conventions.md) and [audience targeting](/nocode/audience-targeting.md) rules based on user profiles Active Directory schema extensions (aka `extension attributes`).
