...
If you enforce MFA for the service account or update its password AFTER it has been configured in SalesTim, you MUST update it from the "Settings" tab using the "🎭 Update" button.
:::
