...
# DEBUG: Print ARG values during build
RUN echo "VITE_API_ENDPOINT=$VITE_API_ENDPOINT" && \
    echo "VITE_AZURE_CLIENT_ID=$VITE_AZURE_CLIENT_ID" && \
    echo "VITE_AZURE_AUTHORITY=$VITE_AZURE_AUTHORITY" && \
    echo "Length of VITE_API_ENDPOINT is: ${#VITE_API_ENDPOINT}"
